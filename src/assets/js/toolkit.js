...
+function (t) {
    ...
    var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        var a = !1, l = 1e6, h = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd otransitionend", transition: "transitionend"}, c = {
            TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
                ...
                for (var r in o)if (o.hasOwnProperty(r)) {
                    var s = o[r], a = n[r], l = a && i(a) ? "element" : e(a);
        ...
        var e = "alert", n = "4.0.0-alpha.6", s = "bs.alert", a = "." + s, l = ".data-api", h = t.fn[e], c = 150, u = {DISMISS: '[data-dismiss="alert"]'}, f = {CLOSE: "close" + a, CLOSED: "closed" + a, CLICK_DATA_API: "click" + a + l},
            d = {ALERT: "alert", FADE: "fade", SHOW: "show"}, _ = function () {
                ...
                return e.prototype.close = function (t) {
                    ...
                    var i = r.getSelectorFromElement(e), n = !1;
        ...
        var e = "button", n = "4.0.0-alpha.6", r = "bs.button", s = "." + r, a = ".data-api", l = t.fn[e], h = {ACTIVE: "active", BUTTON: "btn", FOCUS: "focus"},
            c = {DATA_TOGGLE_CARROT: '[data-toggle^="button"]', DATA_TOGGLE: '[data-toggle="buttons"]', INPUT: "input", ACTIVE: ".active", BUTTON: ".btn"},
            u = {CLICK_DATA_API: "click" + s + a, FOCUS_BLUR_DATA_API: "focus" + s + a + " " + ("blur" + s + a)}, f = function () {
                function e(t) {
                    i(this, e), this._element = t
                }

                return e.prototype.toggle = function () {
                    var e = !0, i = t(this._element).closest(c.DATA_TOGGLE)[0];
                    if (i) {
        ...
        var e = "carousel", s = "4.0.0-alpha.6", a = "bs.carousel", l = "." + a, h = ".data-api", c = t.fn[e], u = 600, f = 37, d = 39, _ = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0},
            g = {interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean"}, p = {NEXT: "next", PREV: "prev", LEFT: "left", RIGHT: "right"},
            ...
            E = {CAROUSEL: "carousel", ACTIVE: "active", SLIDE: "slide", RIGHT: "carousel-item-right", LEFT: "carousel-item-left", NEXT: "carousel-item-next", PREV: "carousel-item-prev", ITEM: "carousel-item"}, v = {
                ACTIVE: ".active",
                ...
                return h.prototype.next = function () {
                    ...
                    var i = t === p.NEXT, n = t === p.PREVIOUS, o = this._getItemIndex(e), r = this._items.length - 1, s = n && 0 === o || i && o === r;
                    if (s && !this._config.wrap)return e;
                    var a = t === p.PREVIOUS ? -1 : 1, l = (o + a) % this._items.length;
                    return l === -1 ? this._items[this._items.length - 1] : this._items[l]
                }, h.prototype._triggerSlideEvent = function (e, i) {
                    var n = t.Event(m.SLIDE, {relatedTarget: e, direction: i});
                    ...
                    var n = this, o = t(this._element).find(v.ACTIVE_ITEM)[0], s = i || o && this._getItemByDirection(e, o), a = Boolean(this._interval), l = void 0, h = void 0, c = void 0;
                    ...
                    if (!f.isDefaultPrevented() && o && s) {
                        ...
                        var d = t.Event(m.SLID, {relatedTarget: s, direction: c});
                    ...
                    return this.each(function () {
                        var i = t(this).data(a), o = t.extend({}, _, t(this).data());
                        "object" === ("undefined" == typeof e ? "undefined" : n(e)) && t.extend(o, e);
                        var r = "string" == typeof e ? e : o.slide;
                        if (i || (i = new h(this, o), t(this).data(a, i)), "number" == typeof e) i.to(e); else if ("string" == typeof r) {
                    ...
                    if (i) {
                        ...
                        if (n && t(n).hasClass(E.CAROUSEL)) {
                            var o = t.extend({}, t(n).data(), t(this).data()), s = this.getAttribute("data-slide-to");
        ...
        var e = "collapse", s = "4.0.0-alpha.6", a = "bs.collapse", l = "." + a, h = ".data-api", c = t.fn[e], u = 600, f = {toggle: !0, parent: ""}, d = {toggle: "boolean", parent: "string"},
            _ = {SHOW: "show" + l, SHOWN: "shown" + l, HIDE: "hide" + l, HIDDEN: "hidden" + l, CLICK_DATA_API: "click" + l + h}, g = {SHOW: "show", COLLAPSE: "collapse", COLLAPSING: "collapsing", COLLAPSED: "collapsed"},
            p = {WIDTH: "width", HEIGHT: "height"}, m = {ACTIVES: ".card > .show, .card > .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, E = function () {
                function l(e, n) {
                ...
                return l.prototype.toggle = function () {
                    ...
                    if (!t(this._element).hasClass(g.SHOW)) {
                        ...
                        if (this._parent && (i = t.makeArray(t(this._parent).find(m.ACTIVES)), i.length || (i = null)), !(i && (n = t(i).data(a), n && n._isTransitioning))) {
                            ...
                            if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                                ...
                                var c = s[0].toUpperCase() + s.slice(1), f = "scroll" + c;
                    ...
                    if (t(this._element).hasClass(g.SHOW)) {
                        ...
                        if (t(this._element).trigger(i), !i.isDefaultPrevented()) {
                            var n = this._getDimension(), o = n === p.WIDTH ? "offsetWidth" : "offsetHeight";
                    ...
                    var e = this, i = t(this._config.parent)[0], n = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]';
                    ...
                    return this.each(function () {
                        var i = t(this), o = i.data(a), r = t.extend({}, f, i.data(), "object" === ("undefined" == typeof e ? "undefined" : n(e)) && e);
        ...
        return t(document).on(_.CLICK_DATA_API, m.DATA_TOGGLE, function (e) {
            e.preventDefault();
            var i = E._getTargetFromElement(this), n = t(i).data(a), o = n ? "toggle" : t(this).data();
        ...
        var e = "dropdown", n = "4.0.0-alpha.6", s = "bs.dropdown", a = "." + s, l = ".data-api", h = t.fn[e], c = 27, u = 38, f = 40, d = 3,
            ...
            g = {BACKDROP: "dropdown-backdrop", DISABLED: "disabled", SHOW: "show"}, p = {
                ...
                return e.prototype.toggle = function () {
                    ...
                    var i = e._getParentFromElement(this), n = t(i).hasClass(g.SHOW);
                    ...
                    var i = void 0, n = r.getSelectorFromElement(e);
                    ...
                    if (/(38|40|27|32)/.test(i.which) && !/input|textarea/i.test(i.target.tagName) && (i.preventDefault(), i.stopPropagation(), !this.disabled && !t(this).hasClass(g.DISABLED))) {
                        var n = e._getParentFromElement(this), o = t(n).hasClass(g.SHOW);
        ...
        var e = "modal", s = "4.0.0-alpha.6", a = "bs.modal", l = "." + a, h = ".data-api", c = t.fn[e], u = 300, f = 150, d = 27, _ = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
            ...
            E = {DIALOG: ".modal-dialog", DATA_TOGGLE: '[data-toggle="modal"]', DATA_DISMISS: '[data-dismiss="modal"]', FIXED_CONTENT: ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top"}, v = function () {
                function h(e, n) {
                ...
                return h.prototype.toggle = function (t) {
                    ...
                    var i = this, n = r.supportsTransitionEnd() && t(this._element).hasClass(m.FADE);
                    ...
                    var i = this, n = t(this._element).hasClass(m.FADE) ? m.FADE : "";
                    ...
                    return this.each(function () {
                        var o = t(this).data(a), r = t.extend({}, h.Default, t(this).data(), "object" === ("undefined" == typeof e ? "undefined" : n(e)) && e);
        ...
        return t(document).on(p.CLICK_DATA_API, E.DATA_TOGGLE, function (e) {
            var i = this, n = void 0, o = r.getSelectorFromElement(this);
            o && (n = t(o)[0]);
        ...
        var e = "tooltip", s = "4.0.0-alpha.6", a = "bs.tooltip", l = "." + a, h = t.fn[e], c = 150, u = "bs-tether", f = {
            animation: !0,
        ...
        }, _ = {TOP: "bottom center", RIGHT: "middle left", BOTTOM: "top center", LEFT: "middle right"}, g = {SHOW: "show", OUT: "out"}, p = {
            HIDE: "hide" + l,
            HIDDEN: "hidden" + l,
            SHOW: "show" + l,
            SHOWN: "shown" + l,
        ...
        }, m = {FADE: "fade", SHOW: "show"}, E = {TOOLTIP: ".tooltip", TOOLTIP_INNER: ".tooltip-inner"}, v = {element: !1, enabled: !1}, T = {HOVER: "hover", FOCUS: "focus", CLICK: "click", MANUAL: "manual"}, y = function () {
            function h(t, e) {
            ...
            return h.prototype.enable = function () {
                ...
                var i = this, n = this.getTipElement(), o = t.Event(this.constructor.Event.HIDE);
                if (this._isTransitioning)throw new Error("Tooltip is transitioning");
                var s = function () {
                ...
                i.forEach(function (i) {
                    if ("click" === i) t(e.element).on(e.constructor.Event.CLICK, e.config.selector, function (t) {
                        ...
                        var n = i === T.HOVER ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN, o = i === T.HOVER ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                ...
                return i = t.extend({}, this.constructor.Default, t(this.element).data(), i), i.delay && "number" == typeof i.delay && (i.delay = {show: i.delay, hide: i.delay}), r.typeCheckConfig(e, i, this.constructor.DefaultType), i
                ...
                return this.each(function () {
                    var i = t(this).data(a), o = "object" === ("undefined" == typeof e ? "undefined" : n(e)) && e;
    ...
    (function (r) {
        var a = "popover", l = "4.0.0-alpha.6", h = "bs.popover", c = "." + h, u = r.fn[a],
            f = r.extend({}, s.Default, {placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),
            d = r.extend({}, s.DefaultType, {content: "(string|element|function)"}), _ = {FADE: "fade", SHOW: "show"}, g = {TITLE: ".popover-title", CONTENT: ".popover-content"}, p = {
                HIDE: "hide" + c,
                HIDDEN: "hidden" + c,
                SHOW: "show" + c,
                SHOWN: "shown" + c,
                ...
                return e(u, s), u.prototype.isWithContent = function () {
                    ...
                    return this.each(function () {
                        var e = r(this).data(h), i = "object" === ("undefined" == typeof t ? "undefined" : n(t)) ? t : null;
        ...
        var e = "scrollspy", s = "4.0.0-alpha.6", a = "bs.scrollspy", l = "." + a, h = ".data-api", c = t.fn[e], u = {offset: 10, method: "auto", target: ""},
            f = {offset: "number", method: "string", target: "(string|element)", children: "string"}, d = {ACTIVATE: "activate" + l, SCROLL: "scroll" + l, LOAD_DATA_API: "load" + l + h},
            _ = {DROPDOWN_ITEM: "dropdown-item", DROPDOWN_MENU: "dropdown-menu", NAV_LINK: "nav-link", NAV: "nav", ACTIVE: "active"}, g = {
                ...
                return h.prototype.refresh = function () {
                    var e = this, i = this._scrollElement !== this._scrollElement.window ? p.POSITION : p.OFFSET, n = "auto" === this._config.method ? i : this._config.method, o = n === p.POSITION ? this._getScrollTop() : 0;
                    this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight();
                    var s = t.makeArray(t(this._selector));
                    s.map(function (e) {
                        var i = void 0, s = r.getSelectorFromElement(e);
                    ...
                    var n = t(i.join(","));
                    if (n.hasClass(_.DROPDOWN_ITEM)) n.closest(g.DROPDOWN).find(g.DROPDOWN_TOGGLE).addClass(_.ACTIVE), n.addClass(_.ACTIVE); else {
        ...
        var e = "tab", n = "4.0.0-alpha.6", s = "bs.tab", a = "." + s, l = ".data-api", h = t.fn[e], c = 150, u = {HIDE: "hide" + a, HIDDEN: "hidden" + a, SHOW: "show" + a, SHOWN: "shown" + a, CLICK_DATA_API: "click" + a + l},
            f = {DROPDOWN_MENU: "dropdown-menu", ACTIVE: "active", DISABLED: "disabled", FADE: "fade", SHOW: "show"}, d = {
                A: "a",
                LI: "li",
                DROPDOWN: ".dropdown",
                ...
                return e.prototype.show = function () {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(f.ACTIVE) || t(this._element).hasClass(f.DISABLED))) {
                        var i = void 0, n = void 0, o = t(this._element).closest(d.LIST)[0], s = r.getSelectorFromElement(this._element);
                        o && (n = t.makeArray(t(o).find(d.ACTIVE)), n = n[n.length - 1]);
                        var a = t.Event(u.HIDE, {relatedTarget: this._element}), l = t.Event(u.SHOW, {relatedTarget: n});
                        if (n && t(n).trigger(a), t(this._element).trigger(l), !l.isDefaultPrevented() && !a.isDefaultPrevented()) {
                            ...
                            var h = function () {
                                var i = t.Event(u.HIDDEN, {relatedTarget: e._element}), o = t.Event(u.SHOWN, {relatedTarget: n});
                    ...
                    var o = this, s = t(i).find(d.ACTIVE_CHILD)[0], a = n && r.supportsTransitionEnd() && (s && t(s).hasClass(f.FADE) || Boolean(t(i).find(d.FADE_CHILD)[0])), l = function () {
        ...
        function e(e) {
            return this.each(function () {
                var o = t(this), r = o.data("bs.affix"), s = "object" == ("undefined" == typeof e ? "undefined" : n(e)) && e;
        ...
        var e = "imageGrid", o = "bs.image-grid", r = '[data-grid="images"]', s = "." + o, a = t.fn[e], l = {padding: 10, targetHeight: 300, display: "inline-block"}, h = {RESIZE: "resize" + s}, c = function () {
            function e(n, o) {
            ...
            return e.prototype.dispose = function () {
                ...
                this._images.each(function (i) {
                    var n = t(this), o = n.is("img") ? n : n.find("img"), r = "undefined" != typeof o.data("width") ? o.data("width") : o.width(), s = "undefined" != typeof o.data("height") ? o.data("height") : o.height();
                ...
                for (var i = this._config.padding * (this._elements.length - 1), n = this._albumWidth - i, o = n / (e - i), r = i, s = (e < this._albumWidth, 0); s < this._elements.length; s++) {
                    var a = t(this._elements[s][0]), l = Math.floor(this._elements[s][1] * o), h = Math.floor(this._elements[s][2] * o), c = s < this._elements.length - 1;
                ...
                var i = {"margin-bottom": this._config.padding + "px", "margin-right": e ? this._config.padding + "px" : 0, display: this._config.display, "vertical-align": "bottom"};
                t.css(i)
                ...
                return this.each(function () {
                    var i = t(this), r = i.data(o), s = t.extend({}, l, i.data(), "object" === ("undefined" == typeof s ? "undefined" : n(s)) && s);
        ...
        var e = "zoom", n = "bs.zoom", s = "v4.0.0-alpha.6", a = '[data-action="zoom"]', l = "." + n, h = (t.fn[e], 80),
            ...
            f = {ZOOM: "zoom", ZOOM_OUT: "zoom-out"}, d = function () {
                ...
                return e.prototype.zoomImage = function () {
                    ...
                    var e = this._fullWidth, i = this._fullHeight, n = (t(window).scrollTop(), e / this._targetImage.width), o = t(window).height() - h, r = t(window).width() - h, s = e / i, a = r / o;
                    ...
                    this._targetImage.offsetWidth;
                    var e = t(this._targetImage).offset(), i = t(window).scrollTop(), n = i + t(window).height() / 2, o = t(window).width() / 2, s = e.top + this._targetImage.height / 2, a = e.left + this._targetImage.width / 2;
                    this._translateY = n - s, this._translateX = o - a;
                    var l = "scale(" + this._imgScaleFactor + ")", h = "translate(" + this._translateX + "px, " + this._translateY + "px)";
                    r.supportsTransitionEnd() || (h += " translateZ(0)"), t(this._targetImage).css({"-webkit-transform": l, "-ms-transform": l, transform: l}), t(this._targetImageWrap).css({
                        "-webkit-transform": h,
                        "-ms-transform": h,
                        transform: h

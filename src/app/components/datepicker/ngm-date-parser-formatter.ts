 ...
 */
export abstract class NgmDateParserFormatter {
    /**
     ...
     */
    abstract parse(value: string): NgmDateStruct;
     ...
     */
    abstract format(date: NgmDateStruct): string;
}

export class NgmDateISOParserFormatter extends NgmDateParserFormatter {
    parse(value: string): NgmDateStruct {
        if (value) {
    ...
    format(date: NgmDateStruct): string {
